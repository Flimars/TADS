...
-- **9) (jump) Crie um trigger que gera um log de todas as alterações na tabela DVD (linha por linha). Para isso crie uma tabela de log com os campos código (serial), comando (INSERT, DELETE ou UPDATE) e descrição (o que ocorreu).
